...
describe('user', function () {
     ...
     */
    it('should return 200 response code, successful get (user/stats)', function (done) {
     ...
     */
    it('should return 401 response code because doesn´t exist authorization (user/stats)', function (done) {
